...
class texinfo(ConanFile):
    name = "binutils"
    version = "github"
    settings = "os", "compiler", "build_type", "arch"

    url = "https://github.com/debian-tex/texinfo"
    git_clone_name = "texinfo"
    
    requires = ["help2man/1.47.16"]
    no_copy_source=True
    ...
    def source(self):
        self.run("git clone {} {}".format(self.url,self.git_clone_name))
